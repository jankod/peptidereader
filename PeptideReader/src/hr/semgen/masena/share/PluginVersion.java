...
/**
 * Kopirao sam klasu iz osgi plugina Version!
...
public class PluginVersion implements Comparable<PluginVersion>, Serializable {
	 ...
	 */
	public static final PluginVersion	emptyVersion	= new PluginVersion(0, 0, 0);
	 ...
	 *         negative.
	 */
	public PluginVersion(int major, int minor, int micro) {
	 ...
	 */
	public PluginVersion(int major, int minor, int micro, String qualifier) {
		if (qualifier == null) {
			qualifier = ""; //$NON-NLS-1$
		}
	 ...
	 *         formatted.
	 */
	public static PluginVersion parseVersion(String version) {
		if (version == null) {
			return emptyVersion;
		}
	...
	public boolean equals(Object object) {
		...
		PluginVersion other = (PluginVersion) object;
		return (major == other.major) && (minor == other.minor)
				&& (micro == other.micro) && qualifier.equals(other.qualifier);
	}

	/**
	 * Compares this <code>PluginVersion</code> object to another object.
	 * 
	 * <p>
	 * A PluginVersion is considered to be <b>less than </b> another version if its
